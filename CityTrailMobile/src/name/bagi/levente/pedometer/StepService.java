...
public class StepService extends Service {
    ...
    private int mSteps;
    private int mParentCoins;
    private int mChildSteps;
    private int mChildCoins;
    private int mPace;
    ...
    public void onCreate() {
        ...
        mState = getSharedPreferences("state", 1);
        ...
        mStepDisplayer.setSteps(mSteps = mState.getInt("parentStepCountKey", 0));
        //initializing all other values to be prsisted in  SharedPreferences
        
       
       mParentCoins=mState.getInt("parentCoinsKey", 0);
       mChildSteps=mState.getInt("childStepCountKey", 0);
       mChildCoins=mState.getInt("childCoinsKey", 0);
       Log.i("BEFORE STARTING PEDOMETER", "VALUES ARE parentsteps="+mSteps+" mParentCoins="+mParentCoins+" mChildSteps="+mChildSteps+" mChildCoins="+mChildCoins);
    ...
    public void onDestroy() {
        ...
        Log.i("Dheera Step Service", "onDestroy..values mSteps= "+mSteps+ " mParentCoins="+mParentCoins+" mChildSteps="+mChildSteps+" mChildCoins="+mChildCoins);
        
        mStateEditor = mState.edit();
        mStateEditor.putInt("parentStepCountKey", mSteps);
        mStateEditor.putInt("parentCoinsKey", mParentCoins);
        mStateEditor.putInt("childStepCountKey",mChildSteps);
        mStateEditor.putInt("childCoinsKey", mChildCoins);
